...
@section('title', 'Create Heavy Divisions')
  
@section('contents')heavydivisions
    <h1 class="mb-0">Add Heavy Divisions</h1>
    <hr />
    <form action="{{ route('heavydivisions.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="row mb-3">
            <div class="col">
